    ...
    if user_id in admins:
        ...
        if text.startswith("бан"):
            try:
                ...
                bot.reply_to(message,f"{mention(user)} котуно сикти  {target_id}")
        ...
        if text.startswith("кик"):
            try:
                ...
                bot.reply_to(message,f"{mention(user)} сигил котогум {target_id}")
        ...
        if text.startswith("мут"):
            try:
                ...
                bot.reply_to(message,f"{mention(user)} озунду жааап алжыбай {target_id} на 1ч")
